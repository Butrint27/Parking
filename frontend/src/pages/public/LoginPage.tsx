...
const LoginPage = () => {
  ...
  className='flex-1 min-h-[500px] h-auto bg-[#f0ecf7] flex flex-col justify-center items-center rounded-r-2xl p-4 max-w-sm'
>
  <h1 className='text-3xl font-bold mb-4 text-[#754eb4]'>Login</h1>
  ...
  <div className='px-2 mt-2 mb-4 w-full flex justify-center gap-2'>
    <h1 className='text-sm'>Don't have an account?</h1>
    <Link
      to={PATH_PUBLIC.register}
      className='text-[#754eb4] border border-[#754eb4] hover:shadow-[0_0_5px_2px_#754eb44c] px-2 py-1 rounded-lg text-sm duration-200'
    >
      Register
    </Link>
  </div>
